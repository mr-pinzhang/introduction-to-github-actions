export const TubiLogo = () => {
  return (
    <svg role="tubi-logo" viewBox="0 0 654.07 191.79" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <style>{`
          .tubi-logo__path {
            fill: #45009d;
